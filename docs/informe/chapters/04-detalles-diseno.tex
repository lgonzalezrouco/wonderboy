...
posible). El intérprete \texttt{runBehaviourStep} consume \emph{una} instrucción por
...
arquetipo (\texttt{patrol}, \texttt{chase} o \texttt{guard}) y a un
...
No hay regresión visual ni cobertura exhaustiva: son \emph{smoke checks} (pruebas
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}p{3.4cm}p{9.6cm}@{}}
    ...
    \texttt{programForEnemyDef} y \emph{tuning} sobre arquetipos. \\
    \texttt{UpdateGameTest} &
