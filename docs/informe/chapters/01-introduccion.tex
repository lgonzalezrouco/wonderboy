...
\begin{enumerate}
  \item Implementar un juego~2D jugable con las mecánicas centrales del dominio: movimiento
    ...
    \emph{respawn} en un \emph{spawn point} y condición de victoria \emph{híbrida}
  ...
  \item Modelar comportamientos de \emph{entity} (en particular \emph{enemy}) mediante un
    ...
    sobre el \emph{world}. Esa separación permite combinar patrones de IA\footnote{En
    este informe, \emph{IA} designa el comportamiento programado de los enemigos, no
    inteligencia artificial generativa.} (patrol,
  ...
  \item Cargar \emph{level definition}s desde JSON: geometría de plataformas,
    ...
    \texttt{behaviourHint} al armar el catálogo del \emph{run}. \texttt{GameConfig}
